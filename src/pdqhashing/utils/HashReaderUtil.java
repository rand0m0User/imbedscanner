 ...
 * hex-formatted 256-bit hash per line, optionally prefixed by "hash=". If a
 * comma and other text follows the hash, it is used as metadata; else, a
 * counter is used as the metadata.
 *
 * Example: ``` f8f8f0cce0f4e84d0e370a22028f67f0b36e2ed596623e1d33e6339c4e9c9b22
 ...
 * ```
 *
 * Example: ``` hash=f8f8...9b22,norm=128,delta=0,quality=100,filename=file1.jpg
...
public class HashReaderUtil {
	...
	// ----------------------------------------------------------------
	public static Hash256AndMetadata<String> loadHashAndMetadataFromStream(BufferedReader reader, int lineCounter)
	...
	// ----------------------------------------------------------------
	public static void loadHashesAndMetadataFromStream(BufferedReader reader,
			Vector<Hash256AndMetadata<String>> vectorOfPairs) throws IOException, PDQHashFormatException {
		while (true) {
	...
	public static void loadHashesAndMetadataFromStreamOrDie(String programName, BufferedReader reader,
		...
		try {
			...
			System.err.printf("%s: could not parse hash \"%s\" from input stream.\n", programName,
					e.getUnacceptableInput());
			System.exit(1);
		}
	}

	// ----------------------------------------------------------------
	public static void loadHashesAndMetadataFromFile(String filename, Vector<Hash256AndMetadata<String>> vectorOfPairs)
			throws IOException, PDQHashFormatException {
	...
	public static void loadHashesAndMetadataFromFileOrDie(String programName, String filename,
			Vector<Hash256AndMetadata<String>> vectorOfPairs) {
		try {
	...
	// ----------------------------------------------------------------
	public static void loadHashesAndMetadataFromFiles(String[] filenames,
			Vector<Hash256AndMetadata<String>> vectorOfPairs) throws IOException, PDQHashFormatException {
	...
	public static void loadHashesAndMetadataFromFilesOrDie(String programName, String[] filenames,
			Vector<Hash256AndMetadata<String>> vectorOfPairs) {
		if (filenames.length == 0) {
			BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
	...
	// ----------------------------------------------------------------
	public static Hash256 loadHashFromStream(BufferedReader reader) throws IOException, PDQHashFormatException {
		String line = reader.readLine();
		if (line == null) {
			return null;
		}
	...
	// ----------------------------------------------------------------
	public static void loadHashesFromStream(BufferedReader reader, Vector<Hash256> vectorOfHashes)
			throws IOException, PDQHashFormatException {
		while (true) {
	...
	// ----------------------------------------------------------------
	public static void loadHashesFromFile(String filename, Vector<Hash256> vectorOfHashes)
			throws IOException, PDQHashFormatException {
		BufferedReader reader = new BufferedReader(new FileReader(filename));
	...
	public static void loadHashesFromFileOrDie(String programName, String filename, Vector<Hash256> vectorOfHashes) {
		try {
			...
			System.err.printf("%s: could not parse hash \"%s\" from file \"%s\".\n", programName,
					e.getUnacceptableInput(), filename);
			System.exit(1);
		}
	}

	// ----------------------------------------------------------------
	public static void loadHashesFromStdin(Vector<Hash256> vectorOfHashes) throws IOException, PDQHashFormatException {
		BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
		loadHashesFromStream(reader, vectorOfHashes);
	}

	public static void loadHashesFromStdinOrDie(String programName, Vector<Hash256> vectorOfHashes) {
		try {
			BufferedReader reader = new BufferedReader(new InputStreamReader(System.in));
			loadHashesFromStream(reader, vectorOfHashes);
		} catch (IOException e) {
	...
	// ----------------------------------------------------------------
	public static void loadHashesFromFiles(String[] filenames, Vector<Hash256> vectorOfHashes)
			throws IOException, PDQHashFormatException {
		if (filenames.length == 0) {
	...
	public static void loadHashesFromFilesOrDie(String programName, String[] filenames,
